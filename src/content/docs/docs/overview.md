...
**param8** is a compact USB MIDI controller built around 8 push-encoders, 2 buttons, and two high-contrast OLED displays. It connects via USB-C as a class-compliant MIDI device and ships with a dedicated Ableton Live remote script for deep integration.
